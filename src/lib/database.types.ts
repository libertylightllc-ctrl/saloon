...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      branch_setting: {
        Args: { p_branch: string; p_default: Json; p_key: string }
        Returns: Json
      }
      ...
      log_access: {
        Args: { p_device: string; p_event: string }
        Returns: undefined
      }
      ...
      set_opening_cash: {
        Args: { p_amount: number; p_branch: string }
        Returns: undefined
      }
      set_opening_stock: {
        Args: { p_branch: string; p_items: Json }
        Returns: undefined
      }
      settle_deposit: {
        Args: {
